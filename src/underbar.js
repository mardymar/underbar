(function () {
    ...
    _.every = function (collection, iterator) {
        ...
        var theCallback = iterator === undefined ? _.identity : iterator;

        return !!_.reduce(collection, function (stillTrue, item) {
            if (stillTrue) {
                return theCallback(item);
            }
            return false;
        }, true);
    };
    ...
    _.some = function (collection, iterator) {
        ...
        return !!_.reduce(collection, function (itemFound, item) {
            if (itemFound) {
                return true;
            }
            return theCallback(item);
    ...
    _.memoize = function (func) {
        ...
        function newFunc(){
            ...
            if(answers[argsString] === undefined) {
                answers[argsString] = func.apply(this, arguments);
            }

            return answers[argsString];
        }
